...
contract ERC1643 is IERC1643, Ownable {
     ...
     */
    function setDocument(bytes32 _name, string calldata _uri, bytes32 _documentHash) external override onlyOwner {
     ...
     */
    function getDocument(bytes32  _name) external override view returns (string memory, bytes32, uint256) {
        return (
